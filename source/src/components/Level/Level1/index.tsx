  ...
  return (
    <div className="bg-[#D9D9D9] px-[99px] py-[96px] rounded-[20px]">
      ...
      <p className="font-poppins text-[12px] leading-[30px] text-black mt-[46px]">
        Selamat datang di level 'BBB: Bukan Baca Biasa!', Zie! <br></br> Apakah kamu siap menjadi pembaca yang tajam dan kritis? 📚 Level ini berkaitan dengan pengembangan keterampilanmu untuk bijak menanggapi serta membedakan antara berita
        palsu dan berita yang benar. Misimu adalah mencapai skor minimal 70 untuk membuka level berikutnya. Kamu tetap bebas keluar dari kuis kapan saja, tetapi ingatlah bahwa progres pengerjaan tidak akan disimpan.
        <br />
        <br />
